        ...
        <div className="pb-10 md:pb-14">
            <div className="relative w-[90%] sm:w-[90%] lg:w-[80%] mx-auto mt-10 md:mt-20">
                ...
                <div className="mt-10 md:mt-14 text-white/80 text-sm md:text-base">
                    <p className="md:w-[75%] leading-loose 2xl:text-lg">Halo, saya Achmad Fauzan Husain. Seorang fullstack web developer yang juga gemar mendesain web. Sedang sibuk mengejar mimpi sambil menikmati prosesnya. Biasa diberi ucapan selamat pada tanggal 13 agustus</p>
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row gap-5">
                        ...
                        <div className="flex justify-between gap-4 flex-col flex-1 leading-loose 2xl:text-lg">
                            <div>
